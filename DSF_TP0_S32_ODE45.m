...
t = {S.Analitica.t, S.DormandPrince.t};
x = {S.Analitica.x1, S.DormandPrince.x1};

optionsNameValStruct.FigureName     = [FileHead '_ODE45_Posicion'];
...
t = {S.Analitica.t, S.DormandPrince.t};
x = {S.Analitica.x2, S.DormandPrince.x2};

optionsNameValStruct.FigureName     = [FileHead '_ODE45_Velocidad'];
optionsNameValStruct.LegendText     = {'Analitica', 'Metodo Dormand-Prince'};
optionsNameValStruct.LineColor      = [[0.1 0.1 0.1]; [0 0.477 0.7410]];
optionsNameValStruct.LineWidth      = [1,2];
optionsNameValStruct.XLabelText     = 'Tiempo [s]';
