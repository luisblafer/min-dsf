...
% MODELO SIMPLIFICADO, EMPLEANDO EN METODO DE DORMAND-PRINCE.
% 
% DECIMADO 1:3
%
...
% METODOS DE DORMAND-PRINCE (ode45)

t = {S.Analitica.t, S.DormandPrinceDecimado.t};
x = {S.Analitica.x1, S.DormandPrinceDecimado.x1};

optionsNameValStruct.FigureName     = [FileHead '_ODE45_Posicion_Decimado'];
optionsNameValStruct.LegendText     = {'Analitica', 'Metodo Dormand-Prince'};
...
t = {S.Analitica.t, S.DormandPrinceDecimado.t};
x = {S.Analitica.x2, S.DormandPrinceDecimado.x2};

optionsNameValStruct.FigureName     = [FileHead '_ODE45_Velocidad_Decimado'];
optionsNameValStruct.LegendText     = {'Analitica', 'Metodo Dormand-Prince'};
optionsNameValStruct.LineColor      = [[0.1 0.1 0.1]; [0 0.477 0.7410]];
optionsNameValStruct.LineWidth      = [1,2];
optionsNameValStruct.XLabelText     = 'Tiempo [s]';
